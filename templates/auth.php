...
<main class="content__main">
  ...
  <form class="form" action="auth.php" method="post">
    <div class="form__row">
      ...
      <input class="form__input<?=(isset($errors['email'])) ? ' form__input--error' : ''?>" type="text" name="email" id="email" value="<?=(isset($dict['email'])) ? $dict['email'] : ''?>" placeholder="Введите e-mail">
